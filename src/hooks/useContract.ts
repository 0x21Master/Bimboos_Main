...
import blind_box_abi from '../abis/blind_box.json'
...
import { ArgentWalletDetector, EnsPublicResolver, EnsRegistrar, BlindBox } from '../abis/types'
...
export function useBlindBoxAbi() {
  return useContract<BlindBox>(BLIND_BOX_ADDRESS, blind_box_abi, false)
}
