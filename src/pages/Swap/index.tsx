...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const userHasSpecifiedInputOutput = Boolean(currencies[Field.INPUT] && currencies[Field.OUTPUT])
          ...
          <AutoColumn gap={'sm'}>
            <div style={{ display: 'relative' }}>
              <CurrencyInputPanel
                ...
                value={formattedAmounts[Field.INPUT] as string}
              ...
              <CurrencyInputPanel
                value={formattedAmounts[Field.OUTPUT] as string}
