...
export type AllV3TicksQuery = { __typename?: 'Query' } & {
  ticks: Array<{ __typename?: 'Tick' } & Pick<Tick, 'tickIdx' | 'liquidityNet' | 'price0' | 'price1'>>
}
...
export type FeeTierDistributionQuery = { __typename?: 'Query' } & {
  _meta?: Maybe<{ __typename?: '_Meta_' } & { block: { __typename?: '_Block_' } & Pick<_Block_, 'number'> }>
  asToken0: Array<{ __typename?: 'Pool' } & Pick<Pool, 'feeTier' | 'totalValueLockedToken0' | 'totalValueLockedToken1'>>
  asToken1: Array<{ __typename?: 'Pool' } & Pick<Pool, 'feeTier' | 'totalValueLockedToken0' | 'totalValueLockedToken1'>>
}

export type AddressHistoryQueryVariables = Exact<{
  owner: Scalars['Bytes']
  first: Scalars['Int']
  skip: Scalars['Int']
}>

export type AddressHistoryQuery = { __typename?: 'Query' } & {
  positionSnapshots: Array<
    { __typename?: 'PositionSnapshot' } & Pick<PositionSnapshot, 'id' | 'owner'> & {
        position: { __typename?: 'Position' } & Pick<Position, 'id'> & {
            tickLower: { __typename?: 'Tick' } & Pick<Tick, 'tickIdx'>
            tickUpper: { __typename?: 'Tick' } & Pick<Tick, 'tickIdx'>
          }
        transaction: { __typename?: 'Transaction' } & {
          mints: Array<
            Maybe<
              { __typename?: 'Mint' } & Pick<
                Mint,
                'owner' | 'origin' | 'id' | 'timestamp' | 'amount' | 'amount0' | 'amount1' | 'amountUSD'
              > & {
                  pool: { __typename?: 'Pool' } & Pick<Pool, 'id' | 'feeTier'> & {
                      token0: { __typename?: 'Token' } & Pick<Token, 'id' | 'symbol' | 'decimals' | 'name'>
                      token1: { __typename?: 'Token' } & Pick<Token, 'id' | 'symbol' | 'decimals' | 'name'>
                    }
                  transaction: { __typename?: 'Transaction' } & Pick<
                    Transaction,
                    'id' | 'blockNumber' | 'timestamp' | 'gasUsed' | 'gasPrice'
                  >
                }
            >
          >
...
export const FeeTierDistributionDocument = `
  ...
  asToken1: pools(
    ...
    `
export const AddressHistoryDocument = `
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    addressHistory: build.query<AddressHistoryQuery, AddressHistoryQueryVariables>({
      query: (variables) => ({ document: AddressHistoryDocument, variables }),
    }),
  }),
})
...
export const {
  ...
  useAddressHistoryQuery,
  useLazyAddressHistoryQuery,
} = injectedRtkApi
