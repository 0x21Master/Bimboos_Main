...
export function useAllLists(): AppState['list']['byUrl'] {
  return useAppSelector((state) => state.list.byUrl)
}
...
export function useActiveListUrls(): string[] | undefined {
  const activeListUrls = useAppSelector((state) => state.list.activeListUrls)
